        ...
        <div className="bg-white p-8 md:p-12 rounded-[32px] shadow-sm border border-zinc-100">
          <div className="prose prose-zinc max-w-none">
            ...
            <p className="text-zinc-600 leading-relaxed mb-8">
              By accessing our website and purchasing The Chat Sales Rescue Kit, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.
            </p>

            <h2 className="text-2xl font-black text-zinc-900 mb-4 tracking-tight">2. Use License</h2>
            <p className="text-zinc-600 leading-relaxed mb-4">
              Permission is granted to temporarily download one copy of the materials (information or software) on The Chat Sales Rescue Kit website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
            ...
            <p className="text-zinc-600 leading-relaxed mb-4">
              The materials on The Chat Sales Rescue Kit website are provided on an 'as is' basis. We make no warranties, expressed or implied, and hereby disclaim and negate all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>
            <p className="text-zinc-600 leading-relaxed mb-8">
